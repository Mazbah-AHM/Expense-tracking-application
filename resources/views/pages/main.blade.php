...
<body>
    <div id="wrapper">
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">Monthly Expense</span><span
                                class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse">
                            <li><a href="{{ route('getmonthly') }}">Create Expense</a></li>
                            <li><a href="{{ route('expenses') }}">Expenses</a></li>
                            <li><a href="graph_rickshaw.html">Statistics</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">Yearly Expense</span><span
                                class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse">
                            <li><a href="{{ route('getyearly') }}">Create Expense</a></li>
                            <li><a href="{{ route('yearlyexpense') }}">Expenses</a></li>
                            <li><a href="graph_rickshaw.html">Statistics</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">Loan Management</span><span
                                class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse">
                            <li><a href="{{ route('getloan') }}">Record Loan</a></li>
                            <li><a href="{{ route('repayloan') }}">Repay Loan</a></li>
                            <li><a href="{{ route('paid') }}">Paid Loan</a></li>
                            <li><a href="graph_rickshaw.html">Statistics</a></li>
                        </ul>
                    </li>
        ...
        <div id="page-wrapper" class="gray-bg">
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        ...
                        <li>
                            <form action="{{ url('logout') }}" method="post">
                                @csrf
                                <button class="btn btn-sm-danger fa fa-sign-out" type='submit'>Log out</button>
                            </form>
                    </ul>
            ...
            <div class="footer">
                <div>
                    <strong>Copyright</strong> Mazbah&copy; 2022
                </div>
            </div>
        </div>
