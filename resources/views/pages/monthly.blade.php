            ...
            <div class="row">
                ...
                <div class="col-md-12 col-md-offset-1">
                    <div class="alert alert-warning text-center" role="alert">
                        Record for Current month already exists! <a href="{{ route('expenses') }}">Click
            ...
            <form method="post" action="{{ route('postmonthly') }}">
                ...
                <div class="form-group row"><label class="col-sm-12 col-form-label"
                        style="text-align:center;"><strong>Travel
                            for current month ({{ $month }})</strong></label>
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <div class="input-group m-b">
                            <div class="input-group-prepend">
                                <span class="input-group-addon">RM</span>
